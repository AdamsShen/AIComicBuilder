...
const DEFAULT_INSTRUCTIONS: Record<string, string> = {
  idea: `作为资深编剧优化这段创意构思，使其更完整、更具可执行性。要求：
1. 明确核心设定：题材/世界观、时代背景、基调（如热血/悬疑/治愈）
2. 补全主要人物：主角的身份、目标与动机，以及关键配角和人物关系
3. 梳理故事主线：起因—发展—转折—结局的大致走向与核心冲突
4. 点出看点与情绪钩子（悬念、反转、爽点或泪点）
5. 保留用户原有创意内核，只做扩写与完善，不偏离原意；输出为一段连贯的中文构思，不要分点标题`,
